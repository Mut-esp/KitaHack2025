                    ...
                    <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                        <div className="relative pl-16">
                            <dt className="text-xl font-semibold font-[GoogleSans-Bold] leading-7 text-gray-700">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-full bg-google-blue-500">
                        ...
                        <div className="relative pl-16">
                            <dt className="text-xl font-semibold font-[GoogleSans-Bold] leading-7 text-gray-700">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-full bg-google-red-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-white">
                        ...
                        <div className="relative pl-16">
                            <dt className="text-xl font-semibold font-[GoogleSans-Bold] leading-7 text-gray-700">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-full bg-google-yellow-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-white">
                        ...
                        <div className="relative pl-16">
                            <dt className="text-xl font-semibold font-[GoogleSans-Bold] leading-7 text-gray-700">
                                <div className="absolute top-0 left-0 flex items-center justify-center w-12 h-12 rounded-full bg-google-green-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-white">
