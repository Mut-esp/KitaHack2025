    ...
    return (
        <section className="container px-6 mx-auto bg-center bg-no-repeat bg-cover">
            <div className="px-6 text-gray-800 md:px-12 lg:text-left xl:px-52">
                ...
                <p className="mt-2 text-3xl text-center font-[GoogleSans-Bold] font-bold dark:text-gray-100">
                ...
                <div className={"flex justify-center text-white text-center mt-4 gap-5"}>
                    ...
                    <button 
                        className="w-48 h-14 border-white relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium rounded-lg bg-gray-200 text-gray-500" disabled>
                        <span className="font-[GoogleSans-Bold] font-bold relative flex px-5 py-3.5 transition-all ease-in duration-75 ">
                            Submit
                        </span>
                    </button>
