                ...
                <div className="px-6 text-center text-gray-800 md:px-12 lg:text-left xl:px-52">
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        <div className="mt-12 lg:mt-0">
                            ...
                            <p className="max-w-2xl mb-6 font-normal text-gray-700 dark:text-gray-400 lg:mb-8">
                                KitaHack is a 2-month event featuring <strong className="font-[GoogleSans-Bold]">
                                    talks, events, and a hackathon </strong>
                                organised by Google Developer Student Clubs Malaysia (GDSC Malaysia)
                            </p>
                            <p className="max-w-2xl mb-6 font-normal text-gray-700 dark:text-gray-400 lg:mb-8">
                        ...
                        <div className="mb-12 lg:mb-0">
                            <img src="images/gsc_home_hero_logo.png" className="w-full rounded-lg shadow-2xl shadow-gray-900 dark:shadow-gray-400" alt="" />
                        </div>
                    </div>
                </div>
            </div>
