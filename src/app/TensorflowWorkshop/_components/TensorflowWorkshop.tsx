...
interface TensorflowWorkshopProps {
    title: string;
    subtitle: string;
    date: string;
    time: string;
...
const TensorflowWorkshop: React.FC<TensorflowWorkshopProps> = ({
    title,
    subtitle,
    date,
    time,
    ...
    return (
        ...
        <main className="container mx-auto flex flex-col justify-center items-center gap-20 py-[8rem] z-0">
            {/* Hero Section */}
            ...
            <section className="w-full flex flex-wrap justify-center items-center px-4">
                ...
                <div className="w-full flex flex-wrap justify-center items-center pt-10 px-4">
                    ...
                    {speakers && speakers.map((speaker, index) => (
                        <div
                            key={index}
                            className="relative w-80 p-4 my-14 mx-6 bg-white rounded-lg flex flex-col justify-center items-center shadow-md dark:bg-gray-800"
                        >
...
export default TensorflowWorkshop;
